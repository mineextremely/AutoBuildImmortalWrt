...
PACKAGES=""
PACKAGES="$PACKAGES attr btrfs-progs chattr f2fs-tools f2fsck lsattr mkf2fs xfs-fsck xfs-mkfs bsdtar pigz gawk getopt tar lscpu"
PACKAGES="$PACKAGES perl-http-date perlbase-file perlbase-getopt perlbase-time perlbase-unicode perlbase-utf8"
PACKAGES="$PACKAGES kmod-usb-net-rtl8152-vendor kmod-nft-tproxy"
